...
import { Badge, Book, Layers2, LayoutGrid, User } from "lucide-react";

const DashboardCards = ({customerCount = 30,toolCount= 20,categoryCount = 30}) => {
  ...
  return <Card className={'h-[9rem] capitalize'} key={index}>
        <CardHeader>
